...
class HomeView(View):
    ...
    def get(self, request):
        ...
        if request.GET.get('search'):
            ...
            posts = posts.filter(Q(body__icontains= data) | Q(slug__icontains= data))
        return render(request, 'home/index.html', {'posts': posts, 'form': self.form_class, 'users': users})
...
class PostDetailView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        messages.error(request, 'this form is empty. please try again.', 'danger')
        return render(request, 'home/detail.html', {'post': self.post_instance, 'comments': self.comments, 'form': self.form_class})
